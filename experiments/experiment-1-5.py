...
def prepare_data_for_online_phase(phase: str) -> tuple[list[User], dict[int, list[Task]]]:
    ...
    with SessionLocal() as session:
        ...
        user_ids = [31, 729, 1127, 1140, 731, 32, 1163, 737, 40, 758, 127, 1167, 774, 129, 1195, 787, 1199, 1222,
                    790, 1225, 810, 1236, 819, 1256, 838, 1272, 864, 1293, 911, 134, 1319, 927, 140, 1320, 933, 154,
                    1342, 940, 159, 1346, 942, 174, 1375, 949, 188, 1377, 974, 193, 1385, 1002, 219, 1397, 227, 1025,
                    1410, 237, 1054, 1422, 242, 1058, 1435, 249, 1070, 1448, 259, 1083, 273, 1454, 1101, 342, 351,
                    368, 398, 406, 408]
...
def run_experiment():
    ...
    for algorithm in ['baseline']:  # do one set for algorithm
        print(f"\n\n------------------------------------------------------------------------------------------------")
        print(f"                                      {algorithm} ")
        print(f"------------------------------------------------------------------------------------------------")
